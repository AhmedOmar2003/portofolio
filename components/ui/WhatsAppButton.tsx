...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-[calc(env(safe-area-inset-bottom)+0.9rem)] right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full border border-white/12 bg-[linear-gradient(135deg,rgba(37,211,102,0.94),rgba(17,24,39,0.92))] shadow-[0_18px_40px_rgba(37,211,102,0.24)] backdrop-blur-xl sm:right-5 sm:h-14 sm:w-14 md:bottom-[calc(env(safe-area-inset-bottom)+2rem)] md:right-8"
    >
      <span className="absolute inset-0 rounded-full border border-white/12" />
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="24" height="24" fill="white" aria-hidden="true">
