...
export default function WhatsAppButton({ href = 'https://wa.me/201050242285' }: WhatsAppButtonProps) {
  ...
  return (
    <motion.a
      ...
      className={`site-whatsapp fixed bottom-[calc(env(safe-area-inset-bottom)+0.9rem)] z-50 flex h-12 w-12 items-center justify-center rounded-full border border-white/16 bg-[linear-gradient(135deg,#8df6c8_0%,#6ad7ff_100%)] text-[#041019] shadow-[0_18px_40px_rgba(106,215,255,0.22)] backdrop-blur-xl sm:h-14 sm:w-14 md:bottom-[calc(env(safe-area-inset-bottom)+2rem)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8df6c8] focus-visible:ring-offset-2 focus-visible:ring-offset-[#050816] ${
